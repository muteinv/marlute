	...
	class Woocommerce_Invoice_Pdf {
		...
		*/		
		private static function init() {
			...
			if ( isset( $_GET[ 'gm_invoice_pdf_refund_id' ], $_GET[ 'order_key' ], $_GET[ 'order_hash' ] ) ) {
		...
		*/	
		public static function media_uploader_scripts() {
			...
			if ( ( ( get_current_screen()->id == apply_filters( 'german_market_screen_id_slug', 'woocommerce_page_german-market' ) ) && isset( $_GET[ 'tab' ] ) && ( $_GET[ 'tab' ] == 'invoice-pdf' ) && isset( $_GET[ 'sub_tab' ] ) && ( $_GET[ 'sub_tab' ] == 'images' || $_GET[ 'sub_tab' ] == 'emails' ) ) || get_current_screen()->id == 'woocommerce_page_wgm-refunds' ){
