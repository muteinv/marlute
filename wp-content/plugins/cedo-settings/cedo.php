<?php
/*
  Plugin Name: Marlute Options
  Plugin URI: Quickdevelopers
  Description: Quickdevelopers Options panel
  Author: Quickdevelopers
  Version: 1.0
  Author URI: 
 */
...
define('CEDO_OPTIONS_MAIN_TABLE', $wpdb->prefix . 'marlute_options');

/* path info */
$pathinfo = pathinfo(__FILE__);
define('CEDO_OPTIONS_MAIN_NAME', 'Marlute Options');
...
class  ThemeJung_cedo_options_main {
    ...
    function admin_menu() {
        ...
        add_menu_page('Marlute Options', 'Marlute Options', 'edit_dashboard', __FILE__, array(&$this, 'menu_admin'), plugins_url('images/logo/16px.png', __FILE__));
